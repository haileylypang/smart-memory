...
function App(){
 ...
 useEffect(()=>{winSound.current=new Audio('/audio/win.mp3');loseSound.current=new Audio('/audio/lose.mp3');winSound.current.volume=.25;loseSound.current.volume=.25},[]);
